...
export function fetchOptionsAddClient(client, customer) {
  return {
    ...
    body: JSON.stringify({
      ...
      reportingDate: client.reportingDate,
      companyNumber: client.companyNumber,
      customerId: customer,
      seniorResponsible: client.seniorResponsible,
      managedBy: client.managedBy,
      ownedBy: client.ownedBy,
      ...
      depnBasisFholdProp: client.depnBasisFholdProp,
      depnBasisFixFittings: client.depnBasisFixFittings,
      depnBasisLongLhold: client.depnBasisLongLhold,
      depnBasisMotorVehicles: client.depnBasisMotorVehicles,
      depnBasisOfficeEquip: client.depnBasisOfficeEquip,
      depnBasisPlantMachinery: client.depnBasisPlantMachinery,
      depnBasisShortLhold: client.depnBasisShortLhold,
      depnRateCompEquip: client.depnRateCompEquip,
      depnRateFholdProp: client.depnRateFholdProp,
      depnRateFixFittings: client.depnRateFixFittings,
      depnRateLongLhold: client.depnRateLongLhold,
      depnRateMotorVehicles: client.depnRateMotorVehicles,
      depnRateOfficeEquip: client.depnRateOfficeEquip,
      depnRatePlantMachinery: client.depnRatePlantMachinery,
      depnRateShortLhold: client.depnRateShortLhold,
    }),
  };
}
